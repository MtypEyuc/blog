...
이러한 경험을 계기로 기술을 직접 다루고, 효율적인 시스템을 구축하는 개발자의 길을 선택하게 됐습니다.
...
모든 과제를 성실히 수행하고, FE와 CS 과목에서 우수 러너로 선정됐습니다.
...
2. 전표 등록
    ...
    - 개발간 느낀점
        ...
        - 중간에 한 명이 학원을 그만두어 인원 부족 상황이 발생해도 적절한 인원 분배를 통해 해결할 수 있다는 것을 느꼈습니다.
