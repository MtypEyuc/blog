    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const data = [
                ...
                { id: 5, name: "한-입-크기로-잘라먹는-타입스크립트", date: "2025-02-17~", description: "한 입 크기로 잘라먹는 타입스크립트", image: "https://cdn.discordapp.com/attachments/1338544385217921084/1339318770383978648/thumbnail.4a986a85.webp?ex=67ae494e&is=67acf7ce&hm=2653bec24683cde1c9fa6bfa46d9a50b5a27ec0a7f5bb755639a84b42a55f2fb&" },
            ];
            setBooks(data);
        };
        fetchData();
